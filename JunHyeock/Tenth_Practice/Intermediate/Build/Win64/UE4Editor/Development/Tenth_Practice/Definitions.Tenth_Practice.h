...
#define UE_PROJECT_NAME Tenth_Practice
#define UE_TARGET_NAME Tenth_PracticeEditor
#define UE_MODULE_NAME "Tenth_Practice"
...
#define TENTH_PRACTICE_API DLLEXPORT
