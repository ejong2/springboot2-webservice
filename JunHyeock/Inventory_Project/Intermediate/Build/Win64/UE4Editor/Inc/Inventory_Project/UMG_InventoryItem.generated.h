...
#ifdef INVENTORY_PROJECT_UMG_InventoryItem_generated_h
#error "UMG_InventoryItem.generated.h already included, missing '#pragma once' in UMG_InventoryItem.h"
#endif
...
public: \
	DECLARE_CLASS(UUMG_InventoryItem, UUserWidget, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/Inventory_Project"), NO_API) \
	DECLARE_SERIALIZER(UUMG_InventoryItem) \
...
#define Inventory_Project_Source_Inventory_Project_UMG_InventoryItem_h_19_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, UUMG_InventoryItem); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(UUMG_InventoryItem); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API UUMG_InventoryItem(UUMG_InventoryItem&&); \
	NO_API UUMG_InventoryItem(const UUMG_InventoryItem&); \
public:
...
template<> INVENTORY_PROJECT_API UClass* StaticClass<class UUMG_InventoryItem>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID Inventory_Project_Source_Inventory_Project_UMG_InventoryItem_h
