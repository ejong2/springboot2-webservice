...
#define UE_PROJECT_NAME Inventory_Project
#define UE_TARGET_NAME Inventory_ProjectEditor
#define UE_MODULE_NAME "Inventory_Project"
...
#define INVENTORY_PROJECT_API DLLEXPORT
